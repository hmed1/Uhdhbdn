...
";
$admin = "-443499731";//ايديك
$tokensim="";//توكن الموقع
$ch="";//معرف قناتك بدون @
...
[['text'=>'ايمو📲','callback_data'=>'sales#imo'],['text'=>'فيسبوك📬','callback_data'=>'sales#facebook']],
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
[['text'=>"شراء النقاط 💰",'url'=>"t.me/innnnn"],['text'=>"القائمة الرئيسية 🔙",'callback_data'=>"back"]],
    ] 
   ])
  ]);
 }
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
[['text'=>"إشتراك 📢",'url'=>"http://t.me/market_ar"],['text'=>" القائمة الرئيسية 🔙",'callback_data'=>"back"]],
    ] 
   ])
  ]);
 }
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
[['text'=>"اضغط هنا",'url'=>"https://t.me/abbb7"],['text'=>" القائمة الرئيسية 🔙",'callback_data'=>"back"]],
    ] 
   ])
  ]);
 }
